...
public partial class MainWindow
{
    ...
    private bool variantsOfPanelOpen = true;
        ...
        DesignLayerResolutionService.Result? layers)
    {
        ...
        var rowStart = ImGui.GetCursorScreenPos();
        var rowWidth = ImGui.GetContentRegionAvail().X;
        var (modHovered, stainHovered, warningHovered) = DesignDetailView.DrawSlotRow(plugin.GameData, label, labelWidth, itemName,
        ...
        CachedBonusItem? entry, AffectedBy affectedBy, DesignLayerResolutionService.Result? layers)
    {
        ...
        var rowStart = ImGui.GetCursorScreenPos();
        var rowWidth = ImGui.GetContentRegionAvail().X;
        var (modHovered, _, _) = DesignDetailView.DrawSlotRow(plugin.GameData, label, labelWidth, itemName,
